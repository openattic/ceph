...
class CephClusterTestCase(unittest.TestCase):
    @mock.patch('dashboard.models.send_command_api.SendCommandApi')
    ...
    @mock.patch('dashboard.models.nodb.NodbModel.get_modified_fields')
    @mock.patch('dashboard.models.send_command_api.SendCommandApi._call_mon_command')
